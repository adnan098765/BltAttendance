...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
          ...
          builder: (context, child) {
            return Stack(
              children: [
                ...
                if (_showShimmer)
                  _buildShimmerOverlay(height, width),
              ],
            );
          },
        ),
  ...
  Widget _buildMenuCard({
    ...
    // Use synchronized animations for all cards based on the main controller
    // This ensures all cards appear at once rather than scattered
    final double delayFactor = delay / 1500;
    final double animValue = (_mainController.value - delayFactor).clamp(0.0, 1.0);
